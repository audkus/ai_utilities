...
def check_requirements():
    ...
    requirements = {
        ...
        "Audio Files": {
            "test_audio directory": "Not required - generated by tests",
            "Audio test files": "Not required - generated by tests"
        },
    }
    ...
    for category, items in requirements.items():
        ...
        for name, status in items.items():
            if isinstance(status, bool):
                ...
                # Handle special case for audio files (descriptive strings)
                if "Not required" in str(status):
                    status_icon = "ℹ️"
