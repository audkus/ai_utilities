...
def main() -> None:
    """Demonstrates how to use the error codes."""
    print(ERROR_AI_USAGE_DISABLED)
    print(ERROR_INVALID_PROMPT)
    print(ERROR_MEMORY_USAGE_EXCEEDED)
    print(ERROR_RATE_LIMIT_EXCEEDED)
    print(ERROR_LOGGING_CODE)
    print(ERROR_CONFIG_INITIALIZATION_FAILED)
    print(ERROR_CONFIG_DEFAULT_SETTING_FAILED)
    print(ERROR_CONFIG_API_KEY_MISSING)
    print(ERROR_CONFIG_MODEL_NAME_MISSING)
    print(ERROR_CONFIG_UNSUPPORTED_PROVIDER)
